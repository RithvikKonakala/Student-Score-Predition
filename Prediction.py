...
app = Flask(__name__)
model = joblib.load(r"D:\New folder\GIT hub\Student Score Predition\Predict.pkl")
...
def predict():
    ...
    if input_features[0] <0 or input_features[0] >=13:
        return render_template('index.html', prediction_text='We give importance to student daily routine and health, so we prefer not to study more than 12 hours.')
